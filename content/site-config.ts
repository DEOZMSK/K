...
export const siteConfig: SiteConfig = {
  ...
  hero: {
    ...
    subheadline:
      ...
      "Искусственный интеллект, созданный Артёмом Ксоросом, соединяет ведическую астрологию, нумерологию и анализ времени, чтобы помочь увидеть свой путь без мистификаций и страха.",
    ctaLabel:
  ...
  chatPreview: {
    ...
    messages: [
      ...
      },
      {
        sender: "bot",
        text:
          "JyotishGPT:\nКогда будешь готова, подключимся с Артёмом, чтобы собрать подробный план и подобрать практики."
      },
      {
        sender: "user",

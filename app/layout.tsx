...
const defaultDescription =
  "JyotishGPT — AI-система, созданная Артемием Ксоросом. Соединяет древние ведические методы и современные технологии, помогая людям познавать себя через нумерологию и сознание времени.";

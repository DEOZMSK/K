...
export function CalculatorCard({ title, description, children }: Props) {
  return (
    <section className="flex h-full w-full flex-col rounded-3xl border border-white/[0.12] bg-[rgba(0,0,0,0.48)] p-3 shadow-2xl shadow-black/40 backdrop-blur-[8px]">

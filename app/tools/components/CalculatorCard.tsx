...
export function CalculatorCard({ title, description, children }: Props) {
  return (
    <section className="flex h-full w-full flex-col rounded-3xl border border-slate-900/20 bg-[linear-gradient(180deg,rgba(255,255,255,0.84)_0%,rgba(246,239,226,0.92)_55%,rgba(236,225,206,0.94)_100%),url('/bg-tools2.webp')] bg-cover bg-top bg-no-repeat p-3 shadow-2xl shadow-amber-950/20">
